...
export class ZedScript {
    ...
    writeJSON(path: string, options: { pretty: boolean }) {
        ...
        if (this.type === 'module') {
            ...
            if (this._version === undefined) {
                throw new Error(
                    "ZedScript object is of type 'sandbox' and version is not defined.",
                );
            }
    ...
    get modules() {
        if (this.type === 'sandbox') {
            throw new Error(
                "ZedScript is of 'sandbox' type and cannot use modules.",
            );
        }
    ...
    get options() {
        if (this.type === 'module') {
            throw new Error(
                "ZedScript is of 'module' type and cannot use options.",
            );
        }
